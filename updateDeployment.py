...
def scale() -> None:
    ...
    # read deployment
    call(["kubectl", "delete", "deployments.apps", "flask-k8s-deployment"])
    call(["kubectl", "apply", "-f", "/home/edgegateway/Documents/NaMe/project/v0.2.0/flask_k8s/deployment.yaml"])
